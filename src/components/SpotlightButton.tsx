...
const SpotlightButton = ({text, link, target}: ButtonProps) => {
  return (
    <div style={{transform: "none"}}>
      <Link href={link} target={target} className="group relative inline-block cursor-pointer rounded-xl bg-zinc-900 p-px font-semibold leading-6 text-white no-underline shadow-2xl shadow-zinc-900">
