  ...
  return (
    <div className="flex justify-center">
      <button
        ...
        className="relative flex items-center justify-center gap-2 px-4 py-2 sm:px-6 sm:py-3 font-bold text-sm sm:text-base lg:text-lg text-text transition-all duration-300 ease-in-out bg-transparent border-none cursor-pointer overflow-hidden group"
      >
